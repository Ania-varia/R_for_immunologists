...
![RStudio layout](blob/fig/01-rstudio.png)

Once you open files, such as R scripts, an editor panel will also open
in the top left.

![RStudio layout with .R file open](blob/fig/01-rstudio-script.png)
...
Now, open a new file (via menu File-->New File)) and save it as Rcourse_1.R
If you'll type your commands here and send them to execute  in the console, you'll have notes from the course.
...
Where is this .csv file? If you do not specify a path to the file, it will be written in your current working directory. You can always check your working directory on the console tab or with:

```{r}
getwd()
```
or change with Session-->Set working directory:
...
cats.df2
```
R objects persist in the environment only for a session. However, you can save them and load in in the future:
