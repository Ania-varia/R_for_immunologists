...
data_for_plot <- clean_from_comment_columns(manual_fract_MLN_postsplit, columns_to_not_take_in = c(
             "Chip",
             "Hitachi_Cup",
             "Facs_Sample_Status",
             "Panel",
             ...
             "Complete",
             "Experiment",
             "Serial_No|Gender.|Genotype.",
             "Comment",
             "Gene_Name.",
             "Mouse_Name."
           ))

data_for_plot <-data_for_plot[, grep("count", colnames(data_for_plot ), invert = TRUE), with=F]

save(data_for_plot, file="data_for_plot.Rdata")
```
